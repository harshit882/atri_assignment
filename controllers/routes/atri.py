...
class Atri:
	def __init__(self, state: Any):
		...
		self.navba = state["navba"]
		self.navbarb = state["navbarb"]
		self.navbara = state["navbara"]
		self.Flex190 = state["Flex190"]
		self.HomeFlex5bpt = state["HomeFlex5bpt"]
		self.pHomeFlex6 = state["pHomeFlex6"]
		self.pHomeFlex10bpt = state["pHomeFlex10bpt"]
		self.pHomeFlex15 = state["pHomeFlex15"]
		self.Div14 = state["Div14"]
		self.pHomeFlex9 = state["pHomeFlex9"]
		...
		self.pHomeTextBox2 = state["pHomeTextBox2"]
		self.pHomeTextBox1 = state["pHomeTextBox1"]
		self.pHomeButton6 = state["pHomeButton6"]
		self.pHomeButton7 = state["pHomeButton7"]
		self.pHomeTextBox3 = state["pHomeTextBox3"]
		self.pHomeImage4 = state["pHomeImage4"]
	...
	@property
	def navba(self):
		self._getter_access_tracker["navba"] = {}
		return self._navba
	@navba.setter
	def navba(self, new_state):
		self._setter_access_tracker["navba"] = {}
		global default_state
		self._navba = Flex(new_state, default_state["navba"])

	@property
	def navbarb(self):
		self._getter_access_tracker["navbarb"] = {}
		return self._navbarb
	@navbarb.setter
	def navbarb(self, new_state):
		self._setter_access_tracker["navbarb"] = {}
		global default_state
		self._navbarb = Flex(new_state, default_state["navbarb"])

	@property
	def navbara(self):
		self._getter_access_tracker["navbara"] = {}
		return self._navbara
	@navbara.setter
	def navbara(self, new_state):
		self._setter_access_tracker["navbara"] = {}
		global default_state
		self._navbara = Flex(new_state, default_state["navbara"])
	...
	@property
	def HomeFlex5bpt(self):
		self._getter_access_tracker["HomeFlex5bpt"] = {}
		return self._HomeFlex5bpt
	@HomeFlex5bpt.setter
	def HomeFlex5bpt(self, new_state):
		self._setter_access_tracker["HomeFlex5bpt"] = {}
		global default_state
		self._HomeFlex5bpt = Flex(new_state, default_state["HomeFlex5bpt"])

	@property
	def pHomeFlex6(self):
		self._getter_access_tracker["pHomeFlex6"] = {}
		return self._pHomeFlex6
	@pHomeFlex6.setter
	def pHomeFlex6(self, new_state):
		self._setter_access_tracker["pHomeFlex6"] = {}
		global default_state
		self._pHomeFlex6 = Flex(new_state, default_state["pHomeFlex6"])

	@property
	def pHomeFlex10bpt(self):
		self._getter_access_tracker["pHomeFlex10bpt"] = {}
		return self._pHomeFlex10bpt
	@pHomeFlex10bpt.setter
	def pHomeFlex10bpt(self, new_state):
		self._setter_access_tracker["pHomeFlex10bpt"] = {}
		global default_state
		self._pHomeFlex10bpt = Flex(new_state, default_state["pHomeFlex10bpt"])

	@property
	def pHomeFlex15(self):
		self._getter_access_tracker["pHomeFlex15"] = {}
		return self._pHomeFlex15
	@pHomeFlex15.setter
	def pHomeFlex15(self, new_state):
		self._setter_access_tracker["pHomeFlex15"] = {}
		global default_state
		self._pHomeFlex15 = Flex(new_state, default_state["pHomeFlex15"])
	...
	@property
	def pHomeFlex9(self):
		self._getter_access_tracker["pHomeFlex9"] = {}
		return self._pHomeFlex9
	@pHomeFlex9.setter
	def pHomeFlex9(self, new_state):
		self._setter_access_tracker["pHomeFlex9"] = {}
		global default_state
		self._pHomeFlex9 = Flex(new_state, default_state["pHomeFlex9"])
	...
	@property
	def pHomeTextBox2(self):
		self._getter_access_tracker["pHomeTextBox2"] = {}
		return self._pHomeTextBox2
	@pHomeTextBox2.setter
	def pHomeTextBox2(self, new_state):
		self._setter_access_tracker["pHomeTextBox2"] = {}
		global default_state
		self._pHomeTextBox2 = TextBox(new_state, default_state["pHomeTextBox2"])

	@property
	def pHomeTextBox1(self):
		self._getter_access_tracker["pHomeTextBox1"] = {}
		return self._pHomeTextBox1
	@pHomeTextBox1.setter
	def pHomeTextBox1(self, new_state):
		self._setter_access_tracker["pHomeTextBox1"] = {}
		global default_state
		self._pHomeTextBox1 = TextBox(new_state, default_state["pHomeTextBox1"])

	@property
	def pHomeButton6(self):
		self._getter_access_tracker["pHomeButton6"] = {}
		return self._pHomeButton6
	@pHomeButton6.setter
	def pHomeButton6(self, new_state):
		self._setter_access_tracker["pHomeButton6"] = {}
		global default_state
		self._pHomeButton6 = Button(new_state, default_state["pHomeButton6"])

	@property
	def pHomeButton7(self):
		self._getter_access_tracker["pHomeButton7"] = {}
		return self._pHomeButton7
	@pHomeButton7.setter
	def pHomeButton7(self, new_state):
		self._setter_access_tracker["pHomeButton7"] = {}
		global default_state
		self._pHomeButton7 = Button(new_state, default_state["pHomeButton7"])

	@property
	def pHomeTextBox3(self):
		self._getter_access_tracker["pHomeTextBox3"] = {}
		return self._pHomeTextBox3
	@pHomeTextBox3.setter
	def pHomeTextBox3(self, new_state):
		self._setter_access_tracker["pHomeTextBox3"] = {}
		global default_state
		self._pHomeTextBox3 = TextBox(new_state, default_state["pHomeTextBox3"])

	@property
	def pHomeImage4(self):
		self._getter_access_tracker["pHomeImage4"] = {}
		return self._pHomeImage4
	@pHomeImage4.setter
	def pHomeImage4(self, new_state):
		self._setter_access_tracker["pHomeImage4"] = {}
		global default_state
		self._pHomeImage4 = Image(new_state, default_state["pHomeImage4"])
	...
	def _to_json_fields(self):
		return {
			"navba": self._navba,
			"navbarb": self._navbarb,
			"navbara": self._navbara,
			"Flex190": self._Flex190,
			"HomeFlex5bpt": self._HomeFlex5bpt,
			"pHomeFlex6": self._pHomeFlex6,
			"pHomeFlex10bpt": self._pHomeFlex10bpt,
			"pHomeFlex15": self._pHomeFlex15,
			"Div14": self._Div14,
			"pHomeFlex9": self._pHomeFlex9,
			"Flex17": self._Flex17,
			"Div15": self._Div15,
			"Flex20": self._Flex20,
			"Flex21": self._Flex21,
			...
			"pHomeTextBox2": self._pHomeTextBox2,
			"pHomeTextBox1": self._pHomeTextBox1,
			"pHomeButton6": self._pHomeButton6,
			"pHomeButton7": self._pHomeButton7,
			"pHomeTextBox3": self._pHomeTextBox3,
			"pHomeImage4": self._pHomeImage4,
